...
#define UNUSED_POSITIONS_LIST {{2, 14}, {3, 12}, {4, 3}, {4, 5}, {4, 7}, {4, 9}, {4, 12}}

#define MATRIX_ROW_PINS {A8, A15, B12, B8, B9}
...
#define AMUX_0_COL_CHANNELS {7, 6, 5, 4, 3, 2, 1, 0, 8, 14, 13, 12, 11, 9, 10}
