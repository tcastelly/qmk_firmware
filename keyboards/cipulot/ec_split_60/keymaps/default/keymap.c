...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    KC_LCTL,  KC_LALT,  KC_LGUI,  KC_SPC,  KC_SPC,         KC_SPC,  KC_SPC,   KC_RGUI,  KC_RALT,  MO(1),    KC_RCTL),
    ...
    _______,  _______,  _______,  _______,  _______,            _______,  _______,  _______,  MO(2),    _______,   _______),
