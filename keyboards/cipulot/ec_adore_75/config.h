...
#define UNUSED_POSITIONS_LIST {{3, 13}, {4, 13}, {5, 3}, {5, 4}, {5, 6}, {5, 7}, {5, 13}}

#define MATRIX_ROW_PINS {B13, B14, B15, A8, B12, A15}
...
#define AMUX_0_COL_CHANNELS {0, 3, 1, 2, 4, 5, 6, 7}

#define AMUX_1_COL_CHANNELS {0, 3, 1, 2, 4, 5, 6}
