...
#define MATRIX_ROW_PINS {B14, B13, B12, A6, A7}

#define AMUX_COUNT 2
#define AMUX_MAX_COLS_COUNT 8

#define AMUX_EN_PINS {B9, B8}

#define AMUX_SEL_PINS {B7, B6, B5}

#define AMUX_COL_CHANNELS_SIZES {7, 8}

#define AMUX_0_COL_CHANNELS {3, 0, 1, 2, 4, 6, 7}

#define AMUX_1_COL_CHANNELS {3, 0, 1, 2, 4, 6, 7, 5}
