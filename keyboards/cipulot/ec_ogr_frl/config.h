...
#define MATRIX_ROW_PINS {B5, B4, B13, B6, B7}

#define AMUX_COUNT 2
#define AMUX_MAX_COLS_COUNT 15

#define AMUX_EN_PINS {A8, A15}

#define AMUX_SEL_PINS {A9, A10, B15, B14}

#define AMUX_COL_CHANNELS_SIZES {15, 3}

#define AMUX_0_COL_CHANNELS {7, 6, 5, 4, 3, 2, 1, 0, 8, 14, 13, 12, 11, 10, 9}

#define AMUX_1_COL_CHANNELS {0, 1, 4}
