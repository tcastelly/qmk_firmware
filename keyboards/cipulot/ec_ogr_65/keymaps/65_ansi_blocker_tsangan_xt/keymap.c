...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    // clang-format off
    [0] = LAYOUT_65_ansi_blocker_tsangan_xt(
        ...
        _______,  _______,  KC_CAPS,  KC_A,     KC_S,     KC_D,  KC_F,    KC_G,  KC_H,   KC_J,  KC_K,  KC_L,     KC_SCLN,  KC_QUOT,            KC_ENTER,             KC_PGDN,
        _______,  _______,  KC_LSFT,            KC_Z,     KC_X,  KC_C,    KC_V,  KC_B,   KC_N,  KC_M,  KC_COMM,  KC_DOT,   KC_SLSH,  KC_RSFT,             KC_UP,     MO(1),
        _______,  _______,  KC_LCTL,  KC_LGUI,  KC_LALT,                            KC_SPC,                                          KC_RCTL,  KC_LEFT,   KC_DOWN,   KC_RIGHT),

    [1] = LAYOUT_65_ansi_blocker_tsangan_xt(
    ...
    [2] = LAYOUT_65_ansi_blocker_tsangan_xt(
