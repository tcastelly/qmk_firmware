...
/* USB Device descriptor parameters now live in info.json (vid/pid/version,
...
// EC actuation thresholds (low/high, uint16 each) persisted in the kb datablock.
...
/* Debounce is 0 (EC does its own analog thresholding) — set via keyboard.json. */
