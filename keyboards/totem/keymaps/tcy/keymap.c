...
tap_dance_action_t tap_dance_actions[] = {
    ...
    [TD_LALT] = ACTION_TAP_DANCE_TAP_HOLD_PERMISSIVE(KC_TAB, KC_LALT),
    ...
    [TD_BSPC] = ACTION_TAP_DANCE_TAP_HOLD_LAYOUT(KC_BSPC, _RAISE),
    [TD_BSPC_OSX] = ACTION_TAP_DANCE_TAP_HOLD_LAYOUT(KC_BSPC, _RAISE),
