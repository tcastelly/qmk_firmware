...
tap_dance_action_t tap_dance_actions[] = {
    ...
    [TD_ENT] = ACTION_TAP_DANCE_TAP_HOLD_PERMISIVE(KC_ENT, KC_LSFT),
    [TD_LSFT] = ACTION_TAP_DANCE_TAP_HOLD_PERMISIVE(KC_ESC, KC_LSFT),
    [TD_LCTL] = ACTION_TAP_DANCE_TAP_HOLD_PERMISIVE(KC_TILD, KC_LCTL),
