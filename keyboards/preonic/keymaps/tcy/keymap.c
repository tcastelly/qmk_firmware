 ...
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * | Ctrl |TG RGB| Alt  | GUI | Lower |    Space    |Raise | Left | Down |  Up  |Right |
 * `-----------------------------------------------------------------------------------'
 */
...
[_RAISE] = LAYOUT_preonic_grid(
  ...
  _______, RGB_RMOD, _______, _______, _______, _______, _______, _______, KC_MNXT, KC_VOLD, KC_VOLU, KC_MPLY
),
